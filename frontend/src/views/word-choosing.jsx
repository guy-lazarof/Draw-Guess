...
export function WordChoosing() {
  ...
  function choosingWord(word) {
    getActionChooseWord(word)
  }
  ...
  return (
    <section className='word-choosing-view'>
      ...
      <div className='choose-word'>
        <div className='easy level' onClick={() => { choosingWord(easyWord[0]) }}>
          <p>Easy</p>
          <p className='points'>(1 points)</p>
          <p>{easyWord}</p>
        </div>
        <div className='medium level' onClick={() => { choosingWord(mediumWord[0]) }}>
          <p>Medium</p>
          <p className='points'>(3 points)</p>
          <p>{mediumWord}</p>
        </div>
        <div className='hard level' onClick={() => { choosingWord(hardWord[0]) }}>
          <p>Hard</p>
